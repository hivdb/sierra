...
public class MutationStatsDef {
	...
	static {
		oMutationStats = newObject()
			...
			.field(newFieldDefinition()
				.type(GraphQLFloat)
				.name("numBinUsualMutations")
				.description("Number of positions with a usual mutation.")
				.build())
			.field(newFieldDefinition()
				.type(GraphQLFloat)
				.name("numBinUnusualMutations")
				.description("Number of positions with an unusual mutation.")
				.build())
			.field(newFieldDefinition()
				.type(GraphQLFloat)
				.name("numDRMs")
