...
public class DrugClassTest {
    ...
    public void testGetDrugsFullDrugClass() {
    	...
    	assertEquals(new ArrayList<Drug<HIV>>(PI.getDrugs()), PIDrugs);
    	...
    	assertEquals(new ArrayList<Drug<HIV>>(NRTI.getDrugs()), NRTIDrugs);
    	...
    	assertEquals(new ArrayList<Drug<HIV>>(NNRTI.getDrugs()), NNRTIDrugs);
    	...
    	assertEquals(new ArrayList<Drug<HIV>>(INSTI.getDrugs()), INSTIDrugs);
    }
