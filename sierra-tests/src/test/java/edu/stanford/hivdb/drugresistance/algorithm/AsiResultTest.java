...
public class AsiResultTest {
	...
	public void testGetDrugClassDrugMutScores() {
		...
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("NVP")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 181, "C"), 60.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("NVP")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 101, "E"), 30.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("NVP")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 100, "I"), 60.0);
		expected.get(hiv.getDrugClass("NNRTI")).put(hiv.getDrug("EFV"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("EFV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 181, "C"), 30.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("EFV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 101, "E"), 15.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("EFV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 100, "I"), 60.0);
		expected.get(hiv.getDrugClass("NNRTI")).put(hiv.getDrug("RPV"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("RPV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 181, "C"), 45.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("RPV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 101, "E"), 45.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("RPV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 100, "I"), 60.0);
		expected.get(hiv.getDrugClass("NNRTI")).put(hiv.getDrug("ETR"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("ETR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 181, "C"), 30.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("ETR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 101, "E"), 15.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("ETR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 100, "I"), 30.0);
		expected.get(hiv.getDrugClass("NNRTI")).put(hiv.getDrug("DOR"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("DOR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 100, "I"), 15.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("DOR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 101, "E"), 15.0);
		expected.get(hiv.getDrugClass("NNRTI")).get(hiv.getDrug("DOR")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 181, "C"), 10.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("ABC"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("ABC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 15.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("ABC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("ABC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 67, "AN"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("D4T"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("D4T")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("D4T")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("D4T")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 67, "AN"), 15.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("TDF"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("TDF")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("TDF")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("TDF")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 67, "AN"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("DDI"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("DDI")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("DDI")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("DDI")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 67, "AN"), 5.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("LMV"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("LMV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 60.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("AZT"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("AZT")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("AZT")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 10.0);
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("AZT")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 67, "AN"), 15.0);
		expected.get(hiv.getDrugClass("NRTI")).put(hiv.getDrug("FTC"), new TreeMap<>());
		expected.get(hiv.getDrugClass("NRTI")).get(hiv.getDrug("FTC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 60.0);
	...
	public void testGetDrugMutScores() {
		...
		expected.put(hiv.getDrug("ABC"), new TreeMap<>());
		expected.get(hiv.getDrug("ABC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 15.0);
		expected.get(hiv.getDrug("ABC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.put(hiv.getDrug("D4T"), new TreeMap<>());
		expected.get(hiv.getDrug("D4T")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrug("D4T")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 10.0);
		expected.put(hiv.getDrug("TDF"), new TreeMap<>());
		expected.get(hiv.getDrug("TDF")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrug("TDF")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.put(hiv.getDrug("DDI"), new TreeMap<>());
		expected.get(hiv.getDrug("DDI")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 10.0);
		expected.get(hiv.getDrug("DDI")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 5.0);
		expected.put(hiv.getDrug("LMV"), new TreeMap<>());
		expected.get(hiv.getDrug("LMV")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 60.0);
		expected.put(hiv.getDrug("AZT"), new TreeMap<>());
		expected.get(hiv.getDrug("AZT")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), -10.0);
		expected.get(hiv.getDrug("AZT")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 219, "Q"), 10.0);
		expected.put(hiv.getDrug("FTC"), new TreeMap<>());
		expected.get(hiv.getDrug("FTC")).put(new CodonMutation<HIV>(hiv.getGene("HIV1RT"), 184, "V"), 60.0);
