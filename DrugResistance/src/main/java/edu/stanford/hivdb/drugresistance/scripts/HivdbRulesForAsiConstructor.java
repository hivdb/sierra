...
// 	 * @throws SQLException
// 	 */
// 	public HivdbRulesForAsiConstructor(HivdbVersion version, HIVDrug drug) throws SQLException {
...
// 				.stream()
// 				.map(ms -> {
// 					String aa = AAUtils.toASIFormat("" + ms.aa);
