...
//	private static Map<String, Map<HIVDrugClass, List<List<String>>>> allRows;
//
//	private static Map<String, Map<HIVDrugClass, TabularRulesComparison>> singletons;
...
//	}
//
//	private TabularRulesComparison(String versionPair, HIVDrugClass drugClass) {
...
//	}
//
//	public static TabularRulesComparison getInstance(String versionPair, HIVDrugClass drugClass) {
...
//			singletons.put(versionPair, new EnumMap<>(HIVDrugClass.class));
//		}
//		Map<HIVDrugClass, TabularRulesComparison> partial = singletons.get(versionPair);
...
//	}
//
//	public static class ComparisonDataLoader implements DataLoader<Map<String, Map<HIVDrugClass, List<List<String>>>>> {
//
...
//
//		@Override
//		public Map<String, Map<HIVDrugClass, List<List<String>>>> load() throws SQLException {
//			Map<String, Map<HIVDrugClass, List<List<String>>>> results = new LinkedHashMap<>();
//
//			for (HivdbVersion[] oneVersionPair : VERSIONPAIRS) {
//
//				Map<HIVDrugClass, List<List<String>>> oneResults = new EnumMap<>(HIVDrugClass.class);
...
//					Map<HIVAAMutation, Map<HIVDrug, Map<HivdbVersion, Integer>>> mutDrugVersionScoreChanges =
//							genMutDrugVersionScoreChanges(drugClass, leftVersion, rightVersion);
//
//					// Print out the score changes for individual mutations
//					for (HIVAAMutation mut : mutDrugVersionScoreChanges.keySet()) {
...
//					Map<String, Map<HIVDrug, Map<HivdbVersion, Integer>>> comboMutDrugVersionScoreChanges =
...
//		}
//
//		protected Map<String, Map<HIVDrug, Map<HivdbVersion, Integer>>> genComboMutVersionScoreChanges(
//				HIVDrugClass drugClass, HivdbVersion leftVersion, HivdbVersion rightVersion)
//				throws SQLException {
//
...
//				Map<String, Map<HIVDrug, Map<HivdbVersion, Integer>>>rulesMap = new LinkedHashMap<>();
//				while (rs.next()) {
//					HIVDrug drug = HIVDrug.valueOf(rs.getString("Drug"));
//					String rule = new MutationSet(
//						// TODO: support HIV2
//						HIVGene.valueOf(HIVStrain.HIV1, drug.getDrugClass().gene()),
//						rs.getString("Rule"))
//						.displayAmbiguities()
//						.join('+');
...
//						rulesMap.put(rule, new HashMap<HIVDrug, Map<HivdbVersion, Integer>>());
//					}
//					Map<HIVDrug, Map<HivdbVersion, Integer>> drugsMap = rulesMap.get(rule);
...
//		}
//
//		protected Map<HIVAAMutation, Map<HIVDrug, Map<HivdbVersion, Integer>>> genMutDrugVersionScoreChanges(
//				HIVDrugClass drugClass, HivdbVersion leftVersion, HivdbVersion rightVersion)
//				throws SQLException {
//
...
//
//			return db.selectAll(sqlStmt, rs -> {
//				Map<HIVAAMutation, Map<HIVDrug, Map<HivdbVersion, Integer>>> mutsMap = new LinkedHashMap<>();
//				while (rs.next()) {
...
//						.replaceAll("#", "_")
//						.replaceAll("~", "-");
//					HIVAAMutation mut = new AAMutation(gene, pos, aa.toCharArray(), 0xff);
//					HIVDrug drug = HIVDrug.valueOf(rs.getString("Drug"));
//					int score = rs.getInt("Score");
//					HivdbVersion version = HivdbVersion.valueOf(rs.getString("Version"));
//					if (!mutsMap.containsKey(mut)) {
//						mutsMap.put(mut, new HashMap<HIVDrug, Map<HivdbVersion, Integer>>());
//					}
