...
public class GeneDRAsiTest {
	...
	public void testGetGene() {
		GeneDR geneDR = new GeneDRAsi(Gene.IN, new MutationSet());
	...
	public void testGetMutationByType() {
		...
		geneDR = new GeneDRAsi(Gene.RT, new MutationSet("RT69T_TT, RT43E"));
	...
	public void testGetCommentsByType() {
		...
		geneDR = new GeneDRAsi(Gene.RT, new MutationSet("RT69T_TT, RT138D"));
		assertEquals(Collections.emptyList(), geneDR.getCommentsByType(CommentType.Major));
	...
	public void testDrugClassHasScoredMuts() {
		GeneDR geneDR = spy(new GeneDRAsi(Gene.IN, new MutationSet()));
